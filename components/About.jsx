        ...
        <>
            <div className="h-screen relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center -mt-16 z-10 text-center ">
                    ...
                    <p className='text-[#AA2490] font-bold font-poppins lg:text-[32px] sm:text-[24px] md:text-[24px] text-[20px] pb-3 '>Code Your Passion, Build Your Legacy.</p>
                    <p className='text-white lg:text-[24px] sm:text-[20px] md:text-[16px] text-[15px] lg:w-[920px] md:w-[620px] w-[360px] '>
